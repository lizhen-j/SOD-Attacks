...
| No. | Pub.   | Title                                                                                                                              | Links                                                                                                                              |
|:---:|:------:|:-----------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------:|
| 01  | PR     | Towards a robust adversarial patch attack against RGB-T crowd counting                                                             | [Paper](https://doi.org/10.1016/j.patcog.2026.113149)/Code                                                                          |
...
| No. | Pub. | Title | Links |
|:---:|:---:|:---:|:---:|
| 01 | AAAI | A2RNet: Adversarial Attack Resilient Network for Robust Infrared and Visible Image Fusion | [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/32504)/[Code](https://github.com/lok-18/A2RNet) |
...
| 03 | TGRS | A Robust Adversarial Defense Algorithm for Enhancing Salient Object Detection in Remote Sensing Image | [Paper]()/Code |
